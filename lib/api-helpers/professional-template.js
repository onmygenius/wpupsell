...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        /* Gradient animations for light theme */
        ...
        .gradient-bg {
            background: linear-gradient(-45deg, #fefefe, #faf8f5, #fff9f0, #faf8f5);
...
<body data-store-url="${storeUrl}">
    ...
    <!-- Hero Section - Luxury Light -->
    <section class="relative overflow-hidden py-20 sm:py-32" style="background: linear-gradient(-45deg, #fefefe, #faf8f5, #fff9f0, #faf8f5) !important; background-size: 400% 400% !important;">
        <!-- Decorative gradient orbs -->
        <div class="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-yellow-400/20 to-transparent rounded-full blur-3xl"></div>
        <div class="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-yellow-400/20 to-transparent rounded-full blur-3xl"></div>
        
        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-4xl text-center">
                <!-- Badge with Store Name -->
                <div class="fade-in-up delay-100 inline-flex items-center gap-2 rounded-full border border-yellow-600/30 bg-yellow-50 px-4 py-2 text-sm mb-8">
                    <span class="text-yellow-600">✨</span>
                    <span class="text-yellow-800 font-semibold">${storeName}</span>
                </div>
                
                <!-- Headline -->
                <h1 class="fade-in-up delay-200 text-6xl sm:text-7xl font-bold tracking-tight mb-4">
                    <span class="gradient-text">${hero.headline || product.name || 'Premium Product'}</span>
                </h1>
                
                <!-- Subheadline -->
                <p class="fade-in-up delay-300 mt-6 text-xl leading-8 text-gray-600 max-w-3xl mx-auto">
                ...
                <div class="fade-in-up delay-400 mt-12 flex flex-col sm:flex-row items-center justify-center gap-8">
                    <div class="text-center">
                        <div class="text-sm text-gray-600 mb-1">Preț Special</div>
    ...
    <section class="py-16 sm:py-24 relative" style="background: #faf8f5 !important;">
        <!-- Floating orbs background -->
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute top-1/4 left-1/4 w-64 h-64 bg-yellow-400/10 rounded-full blur-3xl animate-pulse"></div>
            <div class="absolute bottom-1/4 right-1/4 w-64 h-64 bg-yellow-300/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 1s;"></div>
        </div>
        
        <div class="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            <!-- Glassmorphism Card -->
            <div class="luxury-glass-card p-12 rounded-3xl backdrop-blur-xl bg-white border border-yellow-200/50 shadow-2xl hover:shadow-yellow-500/20 transition-all duration-500 hover:scale-[1.02]">
                <div class="flex items-start gap-6 mb-8">
                    <div class="flex-shrink-0">
                        <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-yellow-500 to-yellow-600 flex items-center justify-center text-3xl shadow-lg shadow-yellow-500/30">
                            💎
                        </div>
                    </div>
                    <div>
                        <h2 class="text-4xl font-bold tracking-tight mb-2 text-gray-900">
                            <span class="gradient-text">Despre Produs</span>
                        </h2>
                        <p class="text-yellow-700 text-sm uppercase tracking-wider font-semibold">${storeName}</p>
                    </div>
                </div>
                
                <div class="text-lg leading-8 text-gray-700 space-y-6 relative">
                    <!-- Decorative line -->
                    <div class="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-yellow-500 via-yellow-400 to-transparent rounded-full"></div>
                    <div class="pl-8">
                        <p class="hover:text-gray-900 transition-colors">${description}</p>
                    </div>
                </div>
                
                <!-- Bottom accent -->
                <div class="mt-8 pt-8 border-t border-yellow-200/50 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-2 h-2 rounded-full bg-yellow-500 animate-pulse"></div>
                        <span class="text-sm text-gray-600 font-medium">Calitate Verificată</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-2 h-2 rounded-full bg-yellow-500 animate-pulse" style="animation-delay: 0.5s;"></div>
                        <span class="text-sm text-gray-600 font-medium">${storeName}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    ${benefits && benefits.length > 0 ? `
    <section class="py-16 sm:py-24" style="background: #ffffff !important;">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center mb-16">
                ...
                <p class="text-gray-600 text-lg">Beneficii premium care fac diferența</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group relative fade-in-up delay-${(index + 1) * 100}">
                    ...
                    <div class="benefit-card-3d relative h-full p-8 rounded-2xl bg-gradient-to-br from-white/10 via-white/5 to-transparent border border-white/10 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-yellow-500/50 hover:shadow-2xl hover:shadow-yellow-500/20 hover:-translate-y-2">
                        ...
                        <!-- Content -->
                        <h3 class="text-2xl font-bold mb-4 text-gray-900 group-hover:text-yellow-700 transition-colors">
    ...
    <section class="py-16 sm:py-24" style="background: #faf8f5 !important;">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center mb-16">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ${socialProof.testimonials.map(t => `
                    <div class="bg-white p-8 rounded-xl border border-yellow-200 hover:border-yellow-500 transition-all shadow-md">
        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ${features.map(feature => `
                    <div class="flex items-start gap-3 bg-yellow-50 p-4 rounded-lg border border-yellow-200 hover:border-yellow-500 transition-all">
            ...
            <div class="mx-auto max-w-3xl divide-y divide-gray-200">
                ...
                <div class="py-6">
                    <button onclick="toggleFAQ(${index})" 
                            class="flex w-full items-start justify-between text-left text-gray-900 hover:text-yellow-600 transition-colors">
                    ...
                    <div id="faq-content-${index}" class="hidden mt-4 pr-12">
                        <p class="text-base text-gray-700 leading-relaxed">${item.answer || 'Răspuns'}</p>
                    </div>
                </div>
                `).join('')}
            </div>
    ...
    <section class="py-16 sm:py-24" style="background: #ffffff !important;">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="relative isolate overflow-hidden rounded-3xl px-6 py-24 text-center shadow-2xl"
                 style="background: linear-gradient(135deg, #faf8f5 0%, #fff9f0 50%, #faf8f5 100%); border: 2px solid #f4d03f;">
                <!-- Decorative elements -->
