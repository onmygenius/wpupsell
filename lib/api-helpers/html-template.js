...
function generateStarterTemplate(product, content, store = {}) {
  ...
  // Use AI-generated section titles if available, otherwise fallback to hardcoded translations
  const t = content.sectionTitles ? {
    whyChoose: content.sectionTitles.whyChoose || defaultTranslations.whyChoose,
    customerReviews: content.sectionTitles.customerReviews || defaultTranslations.customerReviews,
    specifications: content.sectionTitles.specifications || defaultTranslations.specifications,
    faq: content.sectionTitles.faq || defaultTranslations.faq,
    readyToOrder: content.sectionTitles.readyToOrder || defaultTranslations.readyToOrder,
    buyNow: defaultTranslations.buyNow
  } : defaultTranslations;
