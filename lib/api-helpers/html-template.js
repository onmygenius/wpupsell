...
function generateStarterTemplate(product, content, store = {}) {
  ...
  const hero = content.hero || { headline: product.name || 'Premium Product', subheadline: 'High quality product', cta: 'Buy Now' };
...
<body class="bg-gray-50">
    ...
    <section class="bg-white py-20">
        <div class="max-w-6xl mx-auto px-4">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
                ${sectionTitles.whyChoose || 'Why choose'} ${product.name || 'this product'}?
            </h2>
    ...
    <section class="bg-gray-50 py-20">
        <div class="max-w-6xl mx-auto px-4">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
                ${sectionTitles.customerReviews || 'What our customers say'}
            </h2>
    ...
    <section class="bg-white py-20">
        <div class="max-w-4xl mx-auto px-4">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
                ${sectionTitles.specifications || 'Specifications'}
            </h2>
    ...
    <section class="bg-gray-50 py-20">
        <div class="max-w-4xl mx-auto px-4">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
                ${sectionTitles.faq || 'Frequently Asked Questions'}
            </h2>
            <div class="space-y-4">
                ${faq.map((item) => `
    ...
    <section class="bg-white py-20">
        <div class="max-w-4xl mx-auto px-4 text-center">
            <h2 class="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                ${sectionTitles.readyToOrder || 'Ready to order?'}
            </h2>
            <p class="text-xl text-gray-600 mb-8">
                ${hero.subheadline || 'Order now and enjoy premium quality!'}
            </p>
            <a href="${productUrl}" 
               class="inline-block bg-gray-900 text-white px-12 py-4 rounded-xl text-xl font-bold hover:bg-gray-800 transition-all hover:scale-105 shadow-lg">
                ${hero.cta || 'Buy Now'}
